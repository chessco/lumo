...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: '¡Bienvenido!',
        description: `Hola ${user.firstName || user.email}, has iniciado sesión correctamente.`,
      });
      ...
      toast({
        ...
        description: error.response?.data?.message || 'Credenciales inválidas. Por favor, intenta de nuevo.',
      });
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Plataforma Educativa con IA</p>
        </div>
